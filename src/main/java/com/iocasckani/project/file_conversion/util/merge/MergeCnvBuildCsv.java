...
public class MergeCnvBuildCsv {

    public static boolean buildMergeCsv(List<String> list, List<Map<String, Object>> mapList, String fileName, String filePath, List<String> interoduce){
        String f = fileName.toString();
        String filename = f.substring(0,f.indexOf("."))+".csv";
        if(mapList != null && mapList.size()>0){
            java.io.File csvfile = new File("../file/static/file/"+filename);
